...
public class HumanDAO {
    ...
    public List<Human> showMovieCrew(Long movieId, int languageId) throws SQLException, ConnectionNotFoundException {
    ...
    public Human showHumanById(Long humanId, int languageId) throws SQLException, ConnectionNotFoundException {
        Human human = new Human();
        Connection connection = connectionPull.retrieve();
    ...
    public Boolean checkLinksHumanToMovie(Long humanId) throws SQLException, ConnectionNotFoundException {
    ...
    public void deleteHumanCharacteristic(long humanId) throws SQLException, ConnectionNotFoundException {
        Connection connection = connectionPull.retrieve();
    ...
    public void addHumanCharacteristic(Human human, int languageId) throws SQLException, ConnectionNotFoundException {
        Connection connection = connectionPull.retrieve();
